...
if ($set == "dashboard") {
  ...
  if (isset($absensi)) {
    foreach ($absensi as $key => $value) {
      if ($value->absensi_masuk > 0 && $value->keterangan_masuk != "Tidak Masuk") {
        $jmlmasuk++;
      }
      if ($value->absensi_keluar > 0) {
        $jmlkeluar++;
      }
    }
  }
        ...
        <div class="col-lg-12 col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <center><h3 class="box-title">Selamat datang di Beranda Sistem Absensi Face Recognition</h3></center>
