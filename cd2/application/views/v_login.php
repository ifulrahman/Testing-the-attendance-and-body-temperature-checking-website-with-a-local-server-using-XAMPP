...
<body class="hold-transition" style="background:#0099CC;background: url('<?=base_url();?>components/dist/img/login-bg3.jpg');background-size: cover;">
<div class="login-box">
  <div class="login-logo">
    <div class="login-box-body" style="background: rgba(0, 0, 0, 0.3)">
      <a class="" style="color:#fff" href="<?=base_url();?>">Sistem Absensi <b><br>Face Recognition</b></a><br>
    </div>
    <!-- <img src="<?=base_url();?>components/dist/img/logo.png" width="40%" height="auto"> -->
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="background: rgba(0, 0, 0, 0.3)">
    <p class="login-box-msg" style="color:#fff">Silahkan masukan username dan password</p>
